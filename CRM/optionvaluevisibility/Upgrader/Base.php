 ...
 */
class CRM_optionvaluevisibility_Upgrader_Base {
  ...
  static public function instance() {
    if (!self::$instance) {
      ...
      self::$instance = new CRM_optionvaluevisibility_Upgrader(
        'com.optionvaluevisibility.civicrm',
        realpath(__DIR__ . '/../../../')
      );
    }
   ...
   *
   * @code
   * CRM_optionvaluevisibility_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * @endcode
   */
